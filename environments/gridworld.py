# Grid World provides a basic environment for RL agents
...
class GridWorldEnv(object):
    ...
    def __init__(self, grid, terminals, trans_prob=1):
        """
        input:
            grid        2d list of the grid including the reward
        ...
        # otherwise < 1, the rest of the probability are equally spread amongst neighboring states.
    ...
    def get_transition_mat(self):
        ...
        P_a: ndarray = np.zeros((N_STATES, N_STATES, N_ACTIONS))
